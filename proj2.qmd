...
```{r}
# NATALIE MOVE THIS SOMEWHERE ELSE 
...
>>>>>>> 9a4eb75196d1af5083625052570ccb8764682f12
```
...
library(pROC)
roc_score = roc(ACTUALTESTPREDS, PREDICT)  # AUC score
...
<<<<<<< HEAD
\# source: https://www.geeksforgeeks.org/plotting-roc-curve-in-r-programming/
=======
