...
custom_merge = function(df1,df2) {
  ...
  total = total |> mutate(percent_diff = (total[,3] - total[,2])/total[,2])
  print(as.tibble(total))
...
merge_m2_feat = merge_m2 |> select(NDAI,SD,CORR)
merge_m2_lab = merge_m2 |> select(label)
```
