...
no iid - classifications tend to be based on whats around it
...
- and then like... a tree? or logistic regression w three variables? to see most important classifiers?
- just kidding these are fancy and reserved for pt 3 but maybe like pairwise scatterplots for correlation?
...
## a
```{r}
#CHANGE THIS WITH REAL NOT EDA SAMPLE
set.seed(1124)
...
Logistic Regression w CV:  (1, 0 -1 tri logreg) (also, should include x, y)
```{r}
